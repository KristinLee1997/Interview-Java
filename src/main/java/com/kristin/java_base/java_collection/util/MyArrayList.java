...
public class MyArrayList<E> extends AbstractList<E>
    ...
    /**
     * Trims the capacity of this <tt>MyArrayList</tt> instance to be the
     * list's current size.  An application can use this operation to minimize
     * the storage of an <tt>MyArrayList</tt> instance.
     */
    ...
    /**
     * Increases the capacity of this <tt>MyArrayList</tt> instance, if
    ...
    /**
     * Returns a shallow copy of this <tt>MyArrayList</tt> instance.  (The
     * elements themselves are not copied.)
     *
     * @return a clone of this <tt>MyArrayList</tt> instance
     */
    public Object clone() {
        try {
    ...
    /**
     * Save the state of the <tt>MyArrayList</tt> instance to a stream (that
     * is, serialize it).
     *
     * @serialData The length of the array backing the <tt>MyArrayList</tt>
    ...
    /**
     * Reconstitute the <tt>MyArrayList</tt> instance from a stream (that is,
     * deserialize it).
     */
...
//            this.modCount = parent.modCount;
        ...
        public Spliterator<E> spliterator() {
            checkForComodification();
            return new MyArrayListSpliterator<E>(MyArrayList.this, offset,
    ...
    static final class MyArrayListSpliterator<E> implements Spliterator<E> {
        ...
        /*
         * If MyArrayLists were immutable, or structurally immutable (no

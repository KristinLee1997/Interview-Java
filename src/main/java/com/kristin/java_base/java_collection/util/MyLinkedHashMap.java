...
public class MyLinkedHashMap<K, V>
     ...
     * MyHashMap now uses trees for some of its nodes, class
    ...
    /**
     * Constructs an empty <tt>MyLinkedHashMap</tt> instance with the
    ...
    /**
     * MyHashMap.Node subclass for normal MyLinkedHashMap entries.
     */

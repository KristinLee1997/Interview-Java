...
public class MyHashMap<K, V> extends MyAbstractMap<K, V>
    ...
    transient int size;
    /**
     * The number of times this MyHashMap has been structurally modified
     * Structural modifications are those that change the number of mappings in
     * the MyHashMap or otherwise modify its internal structure (e.g.,
     * rehash).  This field is used to make iterators on Collection-views of
     * the MyHashMap fail-fast.  (See ConcurrentModificationException).
     */
    ...
    /**
     * Constructs a new <tt>MyHashMap</tt> with the same mappings as the
     * specified <tt>Map</tt>.  The <tt>MyHashMap</tt> is created with
    ...
    // Callbacks to allow MyLinkedHashMap post-actions
    ...
    /* ------------------------------------------------------------ */
    // Linked MyHashMap support


    /*
     * The following package-protected methods are designed to be
     * overridden by LinkedMyHashMap, but not by any other subclass.
     * Nearly all other internal methods are also package-protected
     * but are declared final, so can be used by LinkedMyHashMap, view
     * classes, and HashSet.
     */
    ...
    /**
     * Entry for Tree bins. Extends MyLinkedHashMap.Entry (which in turn
